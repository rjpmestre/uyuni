...
public class MessageQueue {
    ...
    public static void configureDefaultActions(SaltApi saltApi) {
        ...
        MessageQueue.registerAction(new SyncFromVendorErrataAction(),
                SyncFromVendorErrataEvent.class);
        MessageQueue.registerAction(new SyncFromOriginalErrataAction(),
                SyncFromOriginalErrataEvent.class);
