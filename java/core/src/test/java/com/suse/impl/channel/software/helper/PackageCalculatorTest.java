...
public class PackageCalculatorTest extends BaseTestCaseWithUser {
     ...
     */
    @Test
    public void testCalculateFromVendorMatchEmptyErrataSet() {
    ...
    void testCalculateFromCloneTreeWalksUpCloneHierarchy() {
        ...
        // Calculate
        Map<Errata, List<Package>> result = PackageCalculator.calculateFromCloneTree(clone3, Set.of(errata1, errata2), user, emptySet());
